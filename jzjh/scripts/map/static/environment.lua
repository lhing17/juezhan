local function init()
    local we
    log.info("开始初始化声音、天气等环境，并创建地图上物品...")
    ...
    --- 断肠草
    et.item:new(1227895891, -13670.0, -5176.9)
    et.item:new(1227895891, -15044.5, -4362.7)
    et.item:new(1227895891, -14352.8, -5099.9)
    et.item:new(1227895891, -12961.7, -1926.6)
    et.item:new(1227895891, -11668.2, -3676.2)
    et.item:new(1227895891, -13280.1, -3255.6)
    et.item:new(1227895891, -14558.4, -3730.4)
    et.item:new(1227895891, -12682.9, -5421.0)
    et.item:new(1227895891, -12819.6, -6280.9)
    et.item:new(1227895891, -11757.7, -1760.2)
    et.item:new(1227895891, -11871.1, -1750.7)
    et.item:new(1227895891, -12008.6, -5355.2)

    --- 一品居请帖
    et.item:new(1227897138, -1694.1, -1810.2)
    et.item:new(1227897138, -1881.7, -1924.9)
    et.item:new(1227897138, -1657.2, -1924.9)
    et.item:new(1227897138, -1772.9, -1919.8)
    et.item:new(1227897138, -1894.2, -1812.9)
    et.item:new(1227897138, -1799.6, -1810.2)
end
init()