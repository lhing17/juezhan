...
local function CreateUnitsForPlayer_12()
	...
	SetUnitState(u.handle, UNIT_STATE_MANA, 0)
...
local function CreateUnitsForPlayer_15()
	...
	SetUnitState(Ns.handle, UNIT_STATE_MANA, 0)
	Os = CreateUnit(p, 1328558131, 1655.0, -3879.3, 271.975)
	SetUnitState(Os.handle, UNIT_STATE_MANA, 0)
	Ps = CreateUnit(p, 1328558128, 1877.0, -4346.3, 184.495)
	SetUnitState(Ps.handle, UNIT_STATE_MANA, 0)
	Qs = CreateUnit(p, 1328558129, 1387.8, -4122.2, 342.869)
	SetUnitState(Qs.handle, UNIT_STATE_MANA, 0)
	Ls = CreateUnit(p, 1328558130, 1488.4, -4404.3, 48.963)
	SetUnitState(Ls.handle, UNIT_STATE_MANA, 0)
	LanXin = CreateUnit(p, 1328558643, 1720, -4430.3, 229)
	SetUnitState(LanXin.handle, UNIT_STATE_MANA, 0)
	XuanJin = CreateUnit(p, 1328558666, 1450, -3900, 256)
	SetUnitState(XuanJin.handle, UNIT_STATE_MANA, 0)
