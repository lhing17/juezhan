...
function Zw()
    ...
    SetUnitLifePercentBJ(FENG_SHU.handle, 5)
...
function Trig____________________005Actions()
    ...
    SelectHeroSkill(FENG_SHU, 1095262842)
end
--===========================================================================
